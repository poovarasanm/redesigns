  ...
  <ul class="sidebar-menu">
	...
	<li class="treeview">
	  ...
	  <ul class="treeview-menu">
		...
		<li><a href="/admin/companies.jsp?pt=1"><i class="fa fa-circle-o"></i>Free Companies</a></li>
		<li><a href="/admin/companies.jsp?pt=2"><i class="fa fa-circle-o"></i>Paid Companies</a></li>
	...
	<li class="treeview">
	  ...
	  <ul class="treeview-menu">
		...
		<li><a href="/admin/agents.jsp"><i class="fa fa-circle-o"></i> List</a></li>
	  </ul>
	</li>
	<li class="treeview">
	  <a href="#">
	  ...
	  <ul class="treeview-menu">
		<li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Add</a></li>
		<li><a href="/admin/franchises.jsp"><i class="fa fa-circle-o"></i> List</a></li>
	  </ul>
	</li>
	<li class="treeview">
	  <a href="#">
