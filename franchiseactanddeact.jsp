...
PreparedStatement ps=conn.prepareStatement("select Admin_Employer_login_id,amin_emp_comp_name,admin_emp_username,admin_emp_password,admin_emp_from_date,admin_to_date,mobileno,emailid,admin_emp_status from admin_employeer_login");
...
var goifokay = "/admin/franchiseaction.jsp";
...
%>
	 ...
	 <tr><td colspan="10"><div align="center" class="style1 style2"><strong>Franchise activation/deactivation/delete </strong></div></td>
	 </tr>
	 <tr>
	   <td width="5%">SL.No</td>
...
%>
   ...
   <tr>
    ...
    <td width="14%" ><%=rs1.getString(8)%></td>
	
	
	<td width="5%"><%String st=rs1.getString(9);
...
%>
				...
				|<a style="text-decoration:none" href="/admin/franchiseactanddeact.jsp?pageNo=<%= k %>"> <%= k %></a>
<%
			}
			out.write(" "); 
           }
