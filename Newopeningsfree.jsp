...
Connection conn=DriverManager.getConnection(conStr, dbUser, dbPwd);
  PreparedStatement ps1=conn.prepareStatement("select av_contact_company_name,av_contact_address,av_status_flag,av_contact_mobileno,av_contact_phoneno,av_contact_state,av_contact_city,av_id,av_contact_country from admin_vaccancy  where (av_status_flag IS NULL or av_status_flag='"+flag+"' or av_status_flag ='null') AND post_type='FREE_POST'");// and av_company_id='"+comptype+"' ";
...
%>
	...
	<tr><td colspan="10"><div align="center" class="style1">Job openings approval page for free posting</div></td>
	</tr>
	 <tr>
		<td>Id</td>
...
%>
		...
		<a  style="text-decoration:none" href="/admin/Newopeningsfree?pageNo=<%= i %>&amp;"> <%= i %></a>	
<%				
			}
			out.write(" "); 
		}
...
%>
	 ...
	 <td>Id</td>
	   <td width="13%">Company Name</td>
	   <td width="13%">Contact Address</td>
	   <td width="19%">City</td>
	   <td width="8%">State</td>
	   <td width="8%">Country</td>
	   <td width="7%">Phone No</td>
...
%>
   ...
   <tr>
	...
	<td width="7%" ><%=rs1.getString("av_status_flag")%>&nbsp;</td>
	<td width="15%"><a href="/admin/editjobpaid.jsp?id=<%=rs1.getString("av_id")%>">Edit Job</a>&nbsp;<a href='/admin/ContactsHideShow.jsp?id=<%= rs1.getInt("av_id") %>'>Custmize</a></td>
