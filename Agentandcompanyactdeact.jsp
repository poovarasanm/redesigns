...
PreparedStatement ps=conn.prepareStatement("select agentid,agentcode,username,password,agentname,emailid,mobileno,typeof,fromdate,todate,loginstatus from agentregistration");
...
var goifokay = "/admin/Agentandcompanyactdeactaction.jsp";
...
%>
	 ...
	 <tr><td colspan="10"><div align="center" class="style1 style2"><strong>Agent/Company activation/deactivation/delete </strong></div></td>
	 </tr>
	 <tr>
	   <td width="5%">SL.No</td>
	   <td width="9%"><input type="checkbox" name="allbox" onclick="checkAll();"/>Select All</td>
	   <td width="19%">Agent Code</td>
	   <td width="17%">User Name</td>
	   <td width="12%">Password</td>
	   <td width="11%">Agent/Company Name</td>
	   <td width="14%">Mail Id</td>
	   <td width="8%">Mobile No</td>
	   <td width="5%">Type</td>
	    <td width="5%">Active From Date</td>
	     <td width="5%">Active To Date</td>
...
%>
   ...
   <tr>
	...
	<td width="8%" ><%=rs1.getString(7)%></td>
	<td width="8%" ><%=rs1.getString(8)%></td>
	<td width="8%" ><%=rs1.getString(9)%></td>
	<td width="8%" ><%=rs1.getString(10)%></td>
	
	<td width="5%"><%String st=rs1.getString(11);
...
%>
				...
				|<a style="text-decoration:none" href="/admin/Agentandcompanyactdeact.jsp?pageNo=<%= k %>"> <%= k %></a>
<%
			}
			out.write(" "); 
           }
